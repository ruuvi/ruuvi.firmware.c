...
#endif
#ifndef APP_SENSOR_NR52__DSP_PARAM
#   define APP_SENSOR_NR52_DSP_PARAM 1 //!< Only 1 is valid with LAST
#endif
#ifndef APP_SENSOR_NR52__MODE
#   define APP_SENSOR_NR52__MODE RD_SENSOR_CFG_CONTINUOUS //!< SHTC runs in single-shot mode internally, update data automatically on fetch.
#endif
#ifndef APP_SENSOR_NR52__RESOLUTION
#   define APP_SENSOR_NR52__RESOLUTION RD_SENSOR_CFG_DEFAULT //!< Only default resolution supported.
#endif
#ifndef APP_SENSOR_NR52__SAMPLERATE
#   define APP_SENSOR_NR52__SAMPLERATE RD_SENSOR_CFG_DEFAULT //!< NRF52 sample rate is defined by reads.
#endif
#ifndef APP_SENSOR_NR52__SCALE
#   define APP_SENSOR_NR52__SCALE RD_SENSOR_CFG_DEFAULT //!< Only default is valid.
#endif
