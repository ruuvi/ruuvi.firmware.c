...
#define APPLICATION_ADVERTISING_INTERVAL_MS              (7u*1285u)
...
#define APPLICATION_ADVERTISING_STARTUP_PERIOD_MS        (12000u)
#define APPLICATION_ADVERTISING_STARTUP_INTERVAL_MS      (1010u)
