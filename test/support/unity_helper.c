...
void AssertEqual_rd_sensor_data_t(rd_sensor_data_t expected, rd_sensor_data_t actual, unsigned short line)
{
...
void AssertEqual_app_log_read_state_t(app_log_read_state_t expected, app_log_read_state_t actual, unsigned short line)
{
  UNITY_TEST_ASSERT_EQUAL_UINT64(expected.oldest_element_ms, actual.oldest_element_ms, line,
