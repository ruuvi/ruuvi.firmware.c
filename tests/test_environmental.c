...
static ruuvi_driver_status_t test_run(ruuvi_driver_sensor_init_fp init,
...
ruuvi_driver_status_t test_environmental_run(void)
{
  ...
  RUUVI_DRIVER_ERROR_CHECK(err_code,
                           RUUVI_DRIVER_ERROR_SELFTEST | RUUVI_DRIVER_ERROR_NOT_FOUND);
  #endif
